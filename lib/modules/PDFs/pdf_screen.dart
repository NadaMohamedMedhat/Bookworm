...
class PDFScreen extends StatelessWidget {
  static const routePass = 'PDFbookScreen';
  @override
    ...
    return BlocConsumer<HomeCubit, HomeStates>(
      ...
      builder: (context, state) {
        ...
        onPageError: (page, error) {
          ...
          ).cachedFromUrl(selecteBook.url!,
          placeholder: (double progress) => Center(child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              const Image(image: AssetImage('assets/images/pdfLoading.gif'),height: 150,width: 150,),
...
//PDFView(
                //   filePath: 'http://africau.edu/images/default/sample.pdf',
                // ),